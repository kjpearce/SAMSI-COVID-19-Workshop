%%%%%%%%% Main File (Scenario 3) : SEIR-based model for COVID-19 (See: Perkins, T.A., España, G.
...
%%%%%%%%%
%%%%%%%%% SCENARIO 3: Run AFTER Main_SEIR_Baseline.m 
%%%%%%%%% 
...
title('Scenario 3')
saveas(gcf, [newSubFolder '/Scenario3_1.png'])
...
xlabel('Days Elapsed since Sept 2020')
ylabel('Number of People')
title('Scenario 3: Zoomed In')
saveas(gcf, [newSubFolder '/Scenario3_2.png'])
...
ylabel('Number of People')
title('Scenario 3')
saveas(gcf, [newSubFolder '/Scenario3_3.png'])